...
class Sirst_Dataset(Data.Dataset):
    ...
    def __init__(self, args, mode='train'):
        ...
        base_dir = '/home/data/dusongcheng/dataset/Infrared/SIRST'

        if mode == 'train':
            txtfile = 'trainval.txt'
        elif mode == 'train_ceshi':
            txtfile = 'train_ceshi.txt'
        elif mode == 'val':
            txtfile = 'val.txt'
        elif mode == 'test':
            txtfile = 'test.txt'
        elif mode == 'test_ceshi':
            txtfile = 'test_ceshi.txt'
    ...
    def __getitem__(self, i):
        ...
        if self.mode == 'train':
            ...
            img, mask = self._sync_transform(img, mask)
        elif self.mode == 'val' or self.mode == 'val_ceshi' or self.mode == 'test' or self.mode == 'train_ceshi' or self.mode == 'test_ceshi':
    ...
    def _random_enchance(self, img, mask):
